...
1
```
**دقت داشته باشید که ارزیابی مقادیر پارامترهای ورودی برای این توابع در همان لحظه فراخوانی انجام میشود به همین دلیل خروجی به صورتی هست که در بالا آمده است و نه بصورت زیر:
```shell
** Wrong output
3
3
