...
## تعریف یک slice با اندازه و ظرفیت مشخص
...
## تعریف یک slice با موقعیت های شاخص
...
## مقدار دهی مجدد یکی از المنت های slice یا آرایه
...
## ایجاد یک slice جدید براساس یک slice از پیش تعریف شده
...
fmt.Println(y) //Print [10 20 30 40 50]
...
## خطای index out of range در slice
...
## گسترش (append) المنت های یک slice
...
2. فرق بین خالی بودن {{< tooltip text="خالی بودن" note="nil" >}} آرایه و slice
