...
## تعویق (defer) تابع درون خطی (inline)
...
## تعویق (defer) چند تابع در یک تابع
...
- فراخوانی تابع panic توسط برنامه نویسی در بخش های مختلف برنامه
...
## خطای panic در زمان اجرا (runtime)
...
## خطای panic از قبل تعیین شده توسط برنامه نویس
