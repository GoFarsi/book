...
**کتاب زبان گو فارسی** آموزش زبان گو را به بطور عمیق از مفاهیم پایه تا مفاهیم کاملا پیشرفته و تکنیکی مانند: سینتکس, پارادایم ها,  {{< tooltip text="همزمانی" note="Concurrency" >}} (پایه تا پیشرفته) و همچنین ساختار داده و {{< tooltip text="الگوهای طراحی" note="Design Patterns" >}} و ... می پردازد تا گوفرها درک عمیق و کامل از زبان گو داشته باشند.
