...
## استفاده از اینترفیس به عنوان پارامتر ورودی تابع
...
## استفاده از اشاره گر هنگام پیاده سازی اینترفیس
...
## پیاده سازی اینترفیس برای تایپ های غیر ساختار
...
## پیاده سازی چندتایی اینترفیس برای تایپ
...
## دسترسی به مقادیر داخلی اینترفیس
